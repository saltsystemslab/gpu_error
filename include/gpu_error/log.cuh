...
//entries maintain TID, logID, and a message generated via a cuda string implementation.
...
namespace gpu_error {
	...
	// //implementation uses fixed_vector now as it is embarassingly parallel and much easier to write
	// struct error_log {
